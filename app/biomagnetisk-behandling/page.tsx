...
export const metadata: Metadata = createPageMetadata({
  title: "Biomagnetisk behandling i Stockholm och Östersund",
  description:
    "Biomagnetisk behandling i Stockholm och Östersund för dig som vill arbeta holistiskt med kroppens inre balans och återhämtning.",
  path: "/biomagnetisk-behandling",
});

const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": `${siteConfig.siteUrl}/biomagnetisk-behandling#service`,
  name: "Biomagnetisk behandling",
  serviceType: "Biomagnetism",
  description:
    "En lugn metod där magneter placeras på specifika områden på kroppen för att stödja kroppens balans.",
  url: `${siteConfig.siteUrl}/biomagnetisk-behandling`,
  ...
  return (
    <div className="content-shell pb-24 pt-12 sm:pb-28 lg:pb-32">
      ...
      <section className="floating-section px-4 py-12 sm:px-6 sm:py-14 lg:px-8">
        ...
        <h1 className="mt-3 max-w-[24ch] text-3xl font-semibold leading-tight text-stone-900 sm:text-4xl">
          Biomagnetisk behandling i Stockholm och Östersund
        </h1>
        <p className="mt-6 max-w-3xl text-base leading-relaxed text-stone-700 sm:text-lg">
          Biomagnetisk behandling är en metod där magneter placeras på specifika områden på kroppen
          med syftet att stödja kroppens balans i Stockholm och Östersund.
        </p>
      ...
      <section className="mt-10 max-w-3xl lg:ml-6">
        <article className="rounded-2xl border border-[rgba(198,164,108,0.18)] bg-[rgba(198,164,108,0.035)] px-6 py-8 sm:px-7 sm:py-9">
          ...
          <ul className="mt-6 list-disc space-y-2.5 pl-6 leading-relaxed text-stone-700 marker:text-[rgba(198,164,108,0.95)]">
            <li>Lugn behandling med fokus på återhämtning</li>
            <li>Passar dig som söker ett holistiskt komplement</li>
            <li>Anpassas efter hur du mår för dagen</li>
          </ul>
      ...
      <section className="mt-14 max-w-3xl border-t border-[rgba(198,164,108,0.16)] pt-10 lg:ml-6">
        <h2 className="text-2xl font-semibold text-stone-900">Boka biomagnetisk behandling</h2>
        ...
        <div className="mt-7 flex flex-wrap gap-4">
          <TrackedLink
            ...
            eventSource="biomagnetisk_page_booking"
